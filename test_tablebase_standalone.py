#!/usr/bin/env python3
"""
Standalone test for core tablebase functionality.

Tests the indexing and storage modules without requiring ChessMG to be built.
Imports modules directly to avoid dependency on ChessMG C++ extension.
"""
...
# Import modules directly, avoiding the chessmg package __init__.py
...
def main():
    """Run all tests."""
    print("\n" + "#"*70)
    print("# ChessMG Tablebase - Core Functionality Tests")
    print("#"*70)
    print("\nTesting indexing and storage modules independently...")
    ...
    if passed == total:
        print("✓ All core tablebase tests passed!")
        print("\nNote: Full tablebase generation with retrograde analysis")
        print("      requires ChessMG to be built (see TABLEBASE_README.md).")
